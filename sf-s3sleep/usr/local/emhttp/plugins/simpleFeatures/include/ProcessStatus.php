...
if (isset($_GET['update'])) {
  ...
  $span = "<span class='right'><span id='progress' class='status'>"; $_span = "</span></span>";
}
if ($pid) {
  echo "{$span}Status:<span class='green'>Running</span>{$_span}";
} else {
  echo "{$span}Status:<span class='orange'>Stopped</span>{$_span}";
}
?>